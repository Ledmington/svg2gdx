...
public final class Bezier implements PathElement {
    ...
    private final List<BezierPathElement> elements;

    public Bezier(final boolean isRelative, final List<BezierPathElement> elements) {
    ...
    public BezierPathElement getElement(final int idx) {
